...
from app.services.analytics import (
    ...
    pipeline_velocity,
    pipeline_velocity_by_user,
    product_performance,
    product_user_target_matrix,
    show_cost_data,
    show_revenue_data,
    target_vs_achieved,
    user_breakdown,
...
async def get_analytics(
    ...
    return AnalyticsResponse(
        ...
        pipeline_velocity_by_user=await pipeline_velocity_by_user(db, owner_ids, range_start, range_end),
        target_vs_achieved=await target_vs_achieved(db, owner_ids, range_start, range_end),
        product_user_matrix=await product_user_target_matrix(db, owner_ids, range_start, range_end),
